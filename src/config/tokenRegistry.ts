...
const tokenRegistry = {
  So11111111111111111111111111111111111111112: {
    ...
    extensions: {
      ...
      coingeckoId: 'solana',
      imageURI: '/resources/Solana_logo.png',
    },
  },
  'RAyzRt4zj4DxV3G4GkCGYcKDDEPeeSFX3Tfg51ysQDK': {
    chainId: 101,
    address: 'RAyzRt4zj4DxV3G4GkCGYcKDDEPeeSFX3Tfg51ysQDK',
    symbol: '$RYZ',
    name: 'RAYZ',
    decimals: 6,
    logoURI:
      'https://arweave.net/gcuN4u8syOYFZVRm1kjc8HEx7LW2IjONlcuXqqfZksw',
    tags: [],
    extensions: {
      website: '',
